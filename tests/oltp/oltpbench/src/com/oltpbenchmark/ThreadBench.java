...
public class ThreadBench implements Thread.UncaughtExceptionHandler {
    ...
    private int finalizeWorkers(ArrayList<Thread> workerThreads) throws InterruptedException {
        ...
        for (int i = 0, cnt = workerThreads.size(); i < cnt; i++) {
            ...
            // problems
            t.join(1200000); // wait for 1200second for threads
    ...
    // ISOPredict
    public Results runFixedMultiPhase() throws IOException {
        ...
        // TODO: let workers choose their own transactions
        ...
        try {
            ...
            Results results = new Results(end - start, requests, stats, samples);
    ...
    public static Results runDeterministicBenchmark(List<Worker<? extends BenchmarkModule>> workers, List<WorkloadConfiguration> workConfs) throws QueueLimitException, IOException {
        ThreadBench bench = new ThreadBench(workers, workConfs);
        
        return bench.runFixedMultiPhase();
    }
