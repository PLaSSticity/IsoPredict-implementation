...
public abstract class BenchmarkModule {
     ...
     * @throws IOException
     */
    protected abstract List<Worker<? extends BenchmarkModule>> makeWorkersImpl(boolean verbose, int totalTx) throws IOException;
    ...
    public final List<Worker<? extends BenchmarkModule>> makeWorkers(boolean verbose, int totalTx) throws IOException {
        return (this.makeWorkersImpl(verbose, totalTx));
    }
